                        ...
                        <div class="media__info">
                          ...
                          <h3 class="row__info-creator">
                            ${mv.author.map((author, index) => {
                              return (app.innerHTML = ` <a href="#" class="is-ghost">${author}</a>`);
                            })}
                          </h3>
                        </div>
                      </div>
                ...
                ${this.listExploreSlide.map((exploreSlide, index) => {
                  return app.html`
                        <div class="col col-lg-4 col-md-4 col-6 explore__slide-item 
                            ...
                            ${
                              index > 3 &&
                              index < app.listExploreSlide.length - 1 &&
                              "fifth"
                            }
                            ${
                              index === app.listExploreSlide.length - 1 &&
  ...
  renderSingerSlide() {
    singerLists.forEach((singerList, singerIndex) => {
      singerList.innerHTML = app.html`
            ...
            ${this.listSingerSlide.map((singerSlide, index) => {
              return app.html`
                      ...
                      <div class="row__item-container">
                        <div class="row__item-display br-5">
                          ...
                          <div class="row__item-display-content">
                            ...
                            <h3 class="display__content-title">Sinh Nhật Sao x ${
                              event.name
                            }</h3>
                ...
                <div class="col col-lg-12 col-md-12 col-12">
                    <div class="container__header special__playlist-header">
                        <div class="special__header-display">
                            <img src="${
                              app.specialPlaylists[playlistListIndex].header
                                .image
                            }" alt="">
                        </div>
